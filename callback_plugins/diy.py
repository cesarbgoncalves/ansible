...
class CallbackModule(Default):
    ...
    def v2_runner_on_failed(self, result, ignore_errors=False):
        self._diy_spec = self._get_output_specification(
            ...
            variables=self._get_vars(playbook=self._diy_playbook, play=self._diy_play, task=self._diy_task, result=result),
        )
    ...
    def v2_runner_item_on_ok(self, result):
        self._diy_spec = self._get_output_specification(
            ...
            variables=self._get_vars(
                playbook=self._diy_playbook, play=self._diy_play, task=self._diy_task, result=result, remove_attr_ref_loop=False
            ),
        )
    ...
    def v2_runner_on_start(self, host, task):
        ...
        self._diy_spec = self._get_output_specification(
            loader=self._diy_loader,
            variables=self._get_vars(playbook=self._diy_playbook, play=self._diy_play, host=self._diy_host, task=self._diy_task),
        )
    ...
    def v2_playbook_on_start(self, playbook):
        ...
        self._diy_spec = self._get_output_specification(loader=self._diy_loader, variables=self._get_vars(playbook=self._diy_playbook))
    ...
    def v2_playbook_on_notify(self, handler, host):
        ...
        self._diy_spec = self._get_output_specification(
            loader=self._diy_loader,
            variables=self._get_vars(playbook=self._diy_playbook, play=self._diy_play, host=self._diy_host, handler=self._diy_handler),
        )
    ...
    def v2_playbook_on_task_start(self, task, is_conditional):
        ...
        self._diy_spec = self._get_output_specification(
            loader=self._diy_loader, variables=self._get_vars(playbook=self._diy_playbook, play=self._diy_play, task=self._diy_task)
        )
    ...
    def v2_playbook_on_vars_prompt(
        self, varname, private=True, prompt=None, encrypt=None, confirm=False, salt_size=None, salt=None, default=None, unsafe=None
    ):
        self._diy_spec = self._get_output_specification(loader=self._diy_loader, variables=self._diy_spec["vars"])
    ...
    def v2_playbook_on_stats(self, stats):
        ...
        self._diy_spec = self._get_output_specification(
            loader=self._diy_loader, variables=self._get_vars(playbook=self._diy_playbook, play=self._diy_play, stats=self._diy_stats)
        )
    ...
    def v2_playbook_on_include(self, included_file):
        ...
        self._diy_spec = self._get_output_specification(
            loader=self._diy_loader,
            variables=self._get_vars(
                playbook=self._diy_playbook, play=self._diy_play, task=self._diy_included_file._task, included_file=self._diy_included_file
            ),
        )
